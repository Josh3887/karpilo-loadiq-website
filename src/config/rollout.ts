...
export const ROLLOUT_PHASES: RolloutPhaseConfig[] = [
  {
    ...
    title: "Phase 1 Pilot readiness window.",
    shortLabel: "Pilot 50",
    capacity: 50,
    durationDays: 30,
    startsAt: "2026-05-13T15:00:00Z",
    endsAt: "2026-06-12T15:00:00Z",
    description: "Founder 50 reservations are open while pilot launch systems are finalized.",
    expectation: "No billing is active. Timing may shift as final technical, procedural, and legal readiness checks complete.",
    ctaLabel: "Reserve Founder 50",
    targetRoute: "/pilot-program",
  },
  {
    key: "FOUNDER_PILOT",
    title: "Phase 2 planned for the first 250 users.",
    shortLabel: "Phase 2",
    capacity: 250,
    durationDays: 60,
    startsAt: "2026-06-27T15:00:00Z",
    endsAt: "2026-08-26T15:00:00Z",
    description: "The first controlled launch cohort is planned after founder pilot readiness is validated.",
    expectation: "Phase 2 timing may move while launch systems, support, and payment gates are finalized.",
    ctaLabel: "Join Phase 2 Queue",
    targetRoute: "/launch-promo",
  },
  {
    key: "CONTROLLED_PUBLIC_LAUNCH",
    title: "Phase 3 planned for the last 250 users.",
    shortLabel: "Phase 3",
    capacity: 250,
    durationDays: 90,
    startsAt: "2026-08-26T15:00:00Z",
    endsAt: "2026-11-24T15:00:00Z",
    description: "The second controlled launch cohort follows the first launch cohort after operational readiness review.",
    expectation: "Phase 3 remains capacity-limited and may shift as infrastructure and publication requirements mature.",
