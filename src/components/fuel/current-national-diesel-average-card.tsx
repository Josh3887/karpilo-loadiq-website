      ...
      <div className="flex gap-4">
        ...
        <div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-300">
            Fuel is not just an expense. It is one of the fastest ways a
            good-looking load turns weak after deadhead, MPG, CPM, and
            gross-to-net pressure are modeled together.
          </p>
        </div>
      </div>
